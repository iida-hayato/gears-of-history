...
export const foodProductiveTechDeck = (): TechCard[] => [
  ...
  { id: 'T-F-003',serial:1, name: '水田', buildType:'FoodFacility', description: '食料+3, 要求労働力+2',  kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'foodDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-004',serial:1, name: '水田', buildType:'FoodFacility', description: '食料+3, 要求労働力+2',  kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'foodDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-005',serial:1, name: '水田', buildType:'FoodFacility', description: '食料+3, 要求労働力+2',  kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'foodDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-006',serial:2, name: '輪栽農地', buildType:'FoodFacility', description: '食料+5, 要求労働力+2',  kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'foodDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-007',serial:2, name: '輪栽農地', buildType:'FoodFacility', description: '食料+5, 要求労働力+2',  kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'foodDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-008',serial:2, name: '輪栽農地', buildType:'FoodFacility', description: '食料+5, 要求労働力+2',  kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'foodDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
  { id: 'T-F-009',serial:3, name: 'ビニールハウス農業', buildType:'FoodFacility', description: '食料+8, 要求労働力+3',  kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'foodDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
  { id: 'T-F-010',serial:3, name: 'ビニールハウス農業', buildType:'FoodFacility', description: '食料+8, 要求労働力+3',  kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'foodDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
  { id: 'T-F-011',serial:3, name: 'ビニールハウス農業', buildType:'FoodFacility', description: '食料+8, 要求労働力+3',  kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'foodDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
]
...
export const productiveTechDeck = (): TechCard[] => [
    ...
    { id: 'T-P-003',serial:1, name: 'たたら製鉄場', buildType:'ProdFacility', description: '歯車+3, 要求労働力+2', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'gearDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-004',serial:1, name: 'たたら製鉄場', buildType:'ProdFacility', description: '歯車+3, 要求労働力+2', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'gearDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-005',serial:1, name: 'たたら製鉄場', buildType:'ProdFacility', description: '歯車+3, 要求労働力+2', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'gearDelta', amount: 3, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-006',serial:2, name: '紡績工房', buildType:'ProdFacility', description: '歯車+5, 要求労働力+2', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'gearDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-007',serial:2, name: '紡績工房', buildType:'ProdFacility', description: '歯車+5, 要求労働力+2', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'gearDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-008',serial:2, name: '紡績工房', buildType:'ProdFacility', description: '歯車+5, 要求労働力+2', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'gearDelta', amount: 5, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 2 }] },
    { id: 'T-P-009',serial:3, name: '機械工場', buildType:'ProdFacility', description: '歯車+8, 要求労働力+3', kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'gearDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-P-010',serial:3, name: '機械工場', buildType:'ProdFacility', description: '歯車+8, 要求労働力+3', kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'gearDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-P-011',serial:3, name: '機械工場', buildType:'ProdFacility', description: '歯車+8, 要求労働力+3', kind: 'Tech', cost: 6, vp: 1, effects: [{ tag: 'gearDelta', amount: 8, scope: 'persistent' }, { tag: 'laborReqDelta',scope: 'persistent' , amount: 3 }] },
]

export const infrastructureTechDeck = (): TechCard[] => [
    { id: 'T-I-000',serial:0, name: '道路', buildType:'Infrastructure', description: '歯車-1, 要求労働力-1', kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'gearDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 1 }] },
    { id: 'T-I-001',serial:0, name: '道路', buildType:'Infrastructure', description: '歯車-1, 要求労働力-1', kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'gearDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 1 }] },
    { id: 'T-I-002',serial:1, name: '集落', buildType:'Infrastructure', description: '食料-1, 要求労働力-1', kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'foodDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 1 }] },
    { id: 'T-I-003',serial:1, name: '集落', buildType:'Infrastructure', description: '食料-1, 要求労働力-1', kind: 'Tech', cost: 2, vp: 1, effects: [{ tag: 'foodDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 1 }] },
    { id: 'T-I-004',serial:2, name: '運河', buildType:'Infrastructure', description: '歯車-2, 要求労働力-3', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'gearDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-005',serial:2, name: '運河', buildType:'Infrastructure', description: '歯車-2, 要求労働力-3', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'gearDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-006',serial:3, name: '城下町', buildType:'Infrastructure', description: '食料-2, 要求労働力-3', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'foodDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-007',serial:3, name: '城下町', buildType:'Infrastructure', description: '食料-2, 要求労働力-3', kind: 'Tech', cost: 3, vp: 1, effects: [{ tag: 'foodDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-008',serial:4, name: '上下水道', buildType:'Infrastructure', description: '歯車-1, 要求労働力-3', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'gearDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-009',serial:4, name: '上下水道', buildType:'Infrastructure', description: '歯車-1, 要求労働力-3', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'gearDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-010',serial:5, name: '居住区', buildType:'Infrastructure', description: '食料-1, 要求労働力-3', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'foodDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-011',serial:5, name: '居住区', buildType:'Infrastructure', description: '食料-1, 要求労働力-3', kind: 'Tech', cost: 4, vp: 1, effects: [{ tag: 'foodDelta', amount: -1, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 3 }] },
    { id: 'T-I-012',serial:6, name: '鉄道', buildType:'Infrastructure', description: '歯車-2, 要求労働力-5', kind: 'Tech', cost: 5, vp: 1, effects: [{ tag: 'gearDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 5 }] },
    { id: 'T-I-013',serial:6, name: '鉄道', buildType:'Infrastructure', description: '歯車-2, 要求労働力-5', kind: 'Tech', cost: 5, vp: 1, effects: [{ tag: 'gearDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 5 }] },
    { id: 'T-I-014',serial:7, name: '集合住宅地', buildType:'Infrastructure', description: '食料-2, 要求労働力-5', kind: 'Tech', cost: 5, vp: 1, effects: [{ tag: 'foodDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 5 }] },
    { id: 'T-I-015',serial:7, name: '集合住宅地', buildType:'Infrastructure', description: '食料-2, 要求労働力-5', kind: 'Tech', cost: 5, vp: 1, effects: [{ tag: 'foodDelta', amount: -2, scope: 'persistent' }, { tag: 'laborReduceDelta',scope: 'persistent' , amount: 5 }] },
]
